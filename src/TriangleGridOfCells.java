...
public class TriangleGridOfCells extends GridOfCells{
    ...
    public TriangleGridOfCells (ArrayList<ArrayList<Cell>> cells, HashMap<Integer, Color> colorMap, NeighborProcessor edgeType, NeighborProcessor diagonalNeighbor) {
